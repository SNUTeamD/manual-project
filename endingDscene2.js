class EndingD2 {
  constructor(playerName) {
    ...
    { speaker: "도재인", text: "많은 분들이 그냥 매뉴얼을 따라 얌전히 진행하시더구요."},
    { speaker: "도재인", text: "그 앞에 뭐가 기다리고 있는지도 모르고 ... 저로써는 안타까울 따름입니다."},
    { speaker: "PLAYER", text: "매뉴얼이라면 .. ?"},
    { speaker: "도재인", text: "첫 날 본 매뉴얼 기억 안 나시나요? 그게 ‘그것들’이 인간을 구분하는 방법이죠."},
    { speaker: "도재인", text: "‘그것들’은 인간과 달리 매뉴얼을 볼 필요도 없고, 어떤 감정도 느끼지 못하거든요."},
    { speaker: "도재인", text: "업무를 진행하며 이상한 점 못 느끼셨나요?"},
     { speaker: "도재인", text: " 거기의 ‘직원들’.. 그들은 인간이 아니에요. 인간을 흉내내는 껍데기일 뿐이죠."},
    { speaker: "도재인", text: "그것들은 인간의 공포를 에너지원으로 삼고 있어요."},
    { speaker: "도재인", text: ` ${this.playerName} 님이 있던 곳은 그 에너지 전환 기술을 만들어낸 회사고요.`},
    ...
    { speaker: "도재인", text: ".... 인간이 '그것'들에게 맞설 수 있는 방법은 없어요. 최대한 안전한 곳에 있는 것, 인간임을 들키지 않는 것만이 여러분이 할 수 있는 최선이에요."},
    { speaker: "도재인", text: "하지만, 걱정하지 마세요! 여기는 회사가 전혀 모르는, 정말이지 ‘아주’ 안전한 곳이랍니다."},
    { speaker: "도재인", text: "하하, 그렇게 겁에 질린 표정 하지 마세요."},
    { speaker: "도재인", text: "... 여긴, 안전한 곳이에요."},
    { speaker: "PLAYER", text: "방금 .. 뭐였지?"},
    { speaker: "도재인", text: `그러나 여기에서는 ${this.playerName} 님이 지켜주셔야 할 몇 가지 사항들이 있어요.`},
    { speaker: "도재인", text: "여기 그 사항들을 적은 매뉴얼이에요."},
